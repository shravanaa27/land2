...
function Login() {
    ...
    const submitHandler = (event) => {
        ...
        if (role === 'revenue' && userid === 'revenue1' && password === 'password') {
            setshowIdpassmismatchError(false);
            setShowAlert(true);
        ...
        <div style={myStyle}>
            ...
            <Form>
                ...
                <Stack gap={3} className="col-md-3 mx-auto stack-box" >
                    ...
                    <Form.Control type="userid" placeholder="Enter Userid" onChange={useridChangeHandler} />
                    ...
                    <Stack direction="horizontal" gap={3}>
                        ...
                        <Form.Check name="group1" type="radio" label="SRO" value="sro" onClick={roleChangeHandler} />
                        <Form.Check name="group1" type="radio" label="Revenue" value="revenue" onClick={roleChangeHandler} />
                        <Form.Check name="group1" type="radio" label="Bank" value="bank" onClick={roleChangeHandler} />
                    </Stack>
                    {showRoleError && <p className='errorMessage'>*Role</p>}
                    <Button variant="primary" type="submit" onClick={submitHandler}>
                        Submit
                    </Button>
                    {showIdpassmismatchError && <p className='errorMessage'>Userid/password mismatch</p>}
