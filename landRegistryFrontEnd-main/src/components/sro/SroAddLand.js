    ...
    const verifyButtonHandler = async () => {
        ...
        const response = await fetch(`http://localhost:5000/api/addLand`, {
            ...
            if (response.status === 200) {
                swal("Success", `Added Land ${searchedLandData[0].landId} to blockchain successfully`, "success");
            }
            else {
                swal("Error", `Failed to Add Land ${searchedLandData[0].landId} to blockchain`, "error");
            }
        ...
        <div className='sro-background'>
            ...
            <div className='sro-searchbox'>
                <Stack gap={3} className="col-md-5 mx-auto" >
                    ...
                    <Form.Label className='fw-bold' >Choose any one of the below parameter & enter that reference no. to <u>search from existing database</u> for addition to Blockchain: </Form.Label>
                    <Stack direction="horizontal" gap={3}>
                        ...
                        <Form.Check name="group1" type="radio" label="Re-Survey No" value="resurveyNo" onClick={parameterChangeHandler} />
                        <Form.Check name="group1" type="radio" label="Old Survey No" value="oldSurveyNo" onClick={parameterChangeHandler} />
                    </Stack>
                    ...
                    {showNoRecordFound && <Alert variant='warning'>
                        No data fetched
                    </Alert>}
                </Stack>
            </div>
